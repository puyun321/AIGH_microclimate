...
model.fit([training_input_one,training_input_two], training_output, epochs=100, batch_size=32,validation_split=0.2,callbacks=callback_list,shuffle=True)
...
writer = pd.ExcelWriter('model_performance/cnn-lstm-performance(stateless).xlsx', engine='xlsxwriter')
