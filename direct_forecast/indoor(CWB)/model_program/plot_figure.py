...
cnnlstm_temp_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/cnn-lstm-performance(stateless).xlsx', sheet_name='AirTemp_forecast')

lstm_temp_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/lstm-performance(stateless).xlsx', sheet_name='AirTemp_forecast')
...
plt.legend(["observation (MAE)", "CL-L (%s)"%cnnlstm_mae,"SL-L (%s)"%lstm_mae], loc ="lower right", prop={'size': 7,'weight':'bold'})
plt.savefig('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/Indoor Temperature.png')
...
cnnlstm_RH_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/cnn-lstm-performance(stateless).xlsx', sheet_name='RH_forecast')

lstm_RH_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/lstm-performance(stateless).xlsx', sheet_name='RH_forecast')
...
plt.legend(["observation (MAE)", "CL-L (%s)"%cnnlstm_mae,"SL-L (%s)"%lstm_mae], loc ="lower right", prop={'size': 7,'weight':'bold'})
plt.savefig('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/Indoor Relative Humidity.png')
...
cnnlstm_PAR_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/cnn-lstm-performance(stateless).xlsx', sheet_name='PAR_forecast')
store=cnnlstm_PAR_forecast.iloc[:,2:]
store[store<0]=0
cnnlstm_PAR_forecast.iloc[:,2:]=np.asarray(store)
lstm_PAR_forecast=pd.read_excel('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/lstm-performance(stateless).xlsx', sheet_name='PAR_forecast')
...
plt.legend(["observation (MAE)", "CL-L (%s)"%cnnlstm_mae,"SL-L (%s)"%lstm_mae], loc ="lower right", prop={'size': 7,'weight':'bold'})
plt.savefig('D:/research/溫室/伸港/hybrid_forecast/physical_model/indoor(CWB)/model_performance/Indoor PAR.png')
