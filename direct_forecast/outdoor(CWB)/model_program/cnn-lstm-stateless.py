...
save_path="D:/research/溫室/伸港/direct_forecast/outdoor(CWB)/model/cnn-lstm(stateless).hdf5"
...
writer = pd.ExcelWriter('D:/research/溫室/伸港/direct_forecast/outdoor(CWB)/model_performance/cnn-lstm-performance(stateless).xlsx', engine='xlsxwriter')
