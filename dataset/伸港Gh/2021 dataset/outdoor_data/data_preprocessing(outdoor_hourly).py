...
outdoor=pd.read_csv("D:/database/溫室/伸港Gh/outdoor_data/outdoor_hourly(fulldate).csv")
...
outdoor.to_csv("D:/database/溫室/伸港Gh/outdoor_data/outdoor_hourly(clean).csv")