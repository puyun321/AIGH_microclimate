# -*- coding: utf-8 -*-
"""
Created on Tue Sep  7 11:02:46 2021
...
indoor=pd.read_csv("D:/database/溫室/伸港Gh/indoor_data/indoor_hourly(fulldate).csv")
...
clean_data=pd.DataFrame(interpolate_ghdata(indoor.iloc[:,1:]))
indoor.iloc[:,1:]=np.asarray(clean_data)

indoor.to_csv("D:/database/溫室/伸港Gh/indoor_data/indoor_hourly(clean).csv")